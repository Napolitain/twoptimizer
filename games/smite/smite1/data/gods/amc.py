...
amc_passive = Buff("Ferryman of souls", stats=Stats(hp=998))
...
amc = God(name="Ah Muzen Cab",
          stats=Stats(hp=1910, mana=1030, movement_speed=365, basic_attack_speed=1.27,
                      basic_attack_damage=83, prot_physical=72, prot_magical=30, hp5=21.2,
                      mp5=12),
